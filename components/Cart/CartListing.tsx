...
function CartListing() {
  ...
  return (
    <>
      {isLoading ? ('') : Object.keys(cartListingItems).length !== 0 ? (
        ...
        <div className="container py-4">
          <div className="d-flex justify-content-between">
            ...
            <div className="text-center">
              ...
              <button className="btn btn-outline-danger text-decoration-none  px-1" onClick={() => cLearCartAPIFunc(cartListingItems?.name, setCartListingItems)}>Clear cart</button>
            </div>
          </div>
          <ListViewCard cartListingItems={cartListingItems} setCartListingItems={setCartListingItems} addToCartItem={addToCartItem} RemoveItemCartAPIFunc={RemoveItemCartAPIFunc} selectedMultiLangData={selectedMultiLangData} />
        </div>
