    ...
    return (
        <>
            <div className="border-bottom">
                ...
                <div>
                    <span className={`text-dark  ${styles.price}`}>
                        {`₹ ${productDetailData?.price}`}
                    </span>
                    <del className={`text-dark ps-2 ${styles.price}`}>
                ...
                <Link href="#" className={`my-1 ${styles.priceOnReq}`}>
                    Price on Request
                </Link>
                ...
                <div className="my-1" >
                    ...
                    <span className={`fw-bold ${styles.avalibility}`}>
                        <FaRegCheckCircle className={`text-success me-1 ${styles.stockSection} `} /> 
                         Avaliable
                    </span>
                    
                    <span className={`mx-2 fw-bold  ${styles.avalibility}`}>
                        <FaWindowClose className={`text-danger me-1 ${styles.stockSection} `}/>
                        Out of Stock
                    </span>
            ...
            <div>
                ...
                <p className="my-1">
                    Minimum Order Quantity:  <span className={productDetailData?.min_order_qty > quantity ? "text-danger" : "text-success"}>{productDetailData?.min_order_qty}</span>
                </p>
                ...
                <div className="d-flex my-1 ">
                    ...
                    <div className="mx-2 my-1">
                        <a
                            href={`https://wa.me/?text=${encodeURIComponent("Check this out!")}`}
                            target="_blank"
                ...
                <div className="my-1">
                    <label htmlFor="pincode" className="">Enter Your Pincode Below To Check the Delievry</label>
