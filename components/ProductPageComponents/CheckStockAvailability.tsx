...
const CheckStockAvailability = ({ productVariantData, quantity, handleQtyModificationOnInputEdit, itemList }: any) => {
    return (
        <div>
            {productVariantData?.variants?.length > 0 && productVariantData?.variants?.map((variant: any, index: any) => (
                    ...
                    <div>
                        ...
                        <div className={`my-1 ${styles.detailPriceSection}`}>
                            ...
                            <input
                                ...
                                onChange={(e) => handleQtyModificationOnInputEdit(index, variant?.variant_code, e.target.value)}
                            />
                        </div>
                    </div>
                    <div className="my-1">
