      ...
      <div className="row">
        ...
        <div className="col-md-6" style={{ height: '450px' }}>
          <div className="py-2 h-100">
            ...
            <label className={`product-tt']}`}>Metal:</label>
            <br />
            ...
            {selectedMetal !== 'Platinum' && (
              <>
                <div className="mb-2">
                  <label className={`product-tt']}`}>Purity:</label>
                  <br />
                  {['9Kt', '10Kt', '14Kt', '18Kt'].map((k, i) => (
                    <button
                      key={i}
                      className={`btn btn-sm me-2 metal-btn}  ${selectedPurity === k ? 'btn-secondary' : 'btn-outline-secondary'}`}
                ...
                <div className="mb-2">
                  <label className={`product-tt']}`}>Tone:</label>
                  <br />
                  {['Yellow', 'White', 'Rose'].map((tone, i) => (
                    <button
                      key={i}
                      className={`btn btn-sm me-2 metal-btn} ${selectedTone === tone ? 'btn-secondary' : 'btn-outline-secondary'}`}
                      style={{
            ...
            <div className="mb-2">
              <label className={`product-tt']}`}>Diamond:</label>
              <br />
              {['I1', 'SI', 'VS', 'LGD'].map((type, i) => (
                <button
                  key={i}
                  className={`btn btn-sm me-2 metal-btn} ${selectedDiamond === type ? 'btn-secondary' : 'btn-outline-secondary'}`}
            ...
            <div className="mb-2">
              <label className={`product-tt']}`}>Size:</label>
              <br />
              {['4', '4.5', '5', '5.5', '6', '6.5', '7', '7.5', '8', '8.5'].map((size, i) => (
                <button
                  key={i}
                  className={`btn btn-sm me-2 metal-btn my-1 ${selectedSize === size ? 'btn-secondary' : 'btn-outline-secondary'}`}
