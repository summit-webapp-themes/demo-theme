...
function SidebarHeader({
  ...
  return (
    <div className={`w-100 d-flex flex-column gap-4 align-items-center p-4`} style={{ backgroundColor: '#FFF3E1'}}>
      ...
      <p className="uppercase bg-white w-100 flex justify-content-between gap-5 m-0 py-2 px-3" style={{ border: '1px solid #F6EAD7', borderRadius: '10px'}}>
          ...
          <div className="fs-14 fw-semibold text-end w-25 text-brown" onClick={() => openSidebar('Work Scope')} style={{ cursor: 'pointer', display: 'inline-block'}}>
            Edit
          </div>
        </p>
    </div>
