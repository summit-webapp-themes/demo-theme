      ...
      <header className={stylesNavbar.header}>
        <nav>
          <div className={`${stylesNavbar.navbar} ps-lg-4 pe-lg-4`}>
            <div className="w-100 d-flex justify-content-start py-2 align-items-center">
              ...
              <div className="d-flex justify-content-between align-items-center w-100">
                ...
                <div className={` ${stylesNavbar.inlineList}`}>
                  <ul className="nav list-inline d-flex justify-content-end align-items-center">
                      ...
                      <Link href="/cart" legacyBehavior>
                        <a className={`link-dark ${stylesNavbar.label}`}>
                          <div className={stylesNavbar.icon_container}>
                            ...
                            <span
                              className={`${stylesNavbar.badge} ${stylesNavbar.badge_warning}  ${stylesNavbar.badge_custom} text-white`}
                            >
                              {cartCount}
                            </span>
                          </div>
