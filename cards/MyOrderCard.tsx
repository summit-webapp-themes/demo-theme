                    ...
                    >
                        <div className="d-flex mb-2 pb-0" >
                            <div className="flex-fill">
                                <h6 className="text-capitalize mb-0 mt-2 d-inline-flex">
                                    <b><div>{selectedMultiLangData?.status} </div></b>
                                    <b><div>&nbsp;: {data?.payment_status}</div></b>
                                </h6>
                            </div>
