        ...
        <div className="container mt-4 row">
            {productsData?.map((item: any, index: any) => (
                <div key={`product-card-${item.OdId}-${index}`} className="w-full col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="card p-0 position-relative" style={{ backgroundColor: '##FBFBFB', border: '1px solid #E9E9E9', height: '228px'}}>
                        <Form.Check 
                            type="checkbox" 
                            ...
                            className="position-absolute z-3" style={{top: '0.25rem', right: '0.5rem'}} />
                        <Image
                            src={noImage}
                            className=""
                    ...
                    <div className="p-2" >
                        <p className="m-0 text-break" style={{ fontSize: '12px', color: '#A69476'}}>&#8377;{item.OdSalPrc}</p>
                        <p className="m-0 text-break" style={{ fontSize: '14px', fontWeight: 600}}>{item.OdNo} | {item.OdKt}Kt | {item.DiaWt}Wt</p>
                    </div>
                </div>
            ))}
        </div>
